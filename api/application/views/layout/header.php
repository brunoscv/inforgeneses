...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/jquery-draw/css/bcPaint.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/jquery-draw/css/bcPaint.mobile.css">
	<!-- Argon CSS -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/argon.css?v=1.1.0" type="text/css">	
	<script src="<?php echo base_url(); ?>assets/vendor/jquery/dist/jquery.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/mask/jquery.inputmask.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/mask/inputmask.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/mask/bindings/inputmask.binding.js"></script>
